 ...
 * @example
 ...
 <View style={styles.avatarContainer}>
     <Avatar src="http://rnui.js.org/user/image/favicon.png"/>
     <Avatar size={60} src="http://rnui.js.org/user/image/favicon.png"/>
     <Avatar size={80} src="http://rnui.js.org/user/image/favicon.png"/>
     <Avatar size={120} src="http://rnui.js.org/user/image/favicon.png"/>
 </View>
 */
